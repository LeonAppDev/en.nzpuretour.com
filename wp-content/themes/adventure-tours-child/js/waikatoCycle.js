  ...
  $('select.select2-selector').change(
    ...
    //  alert("Value changed "+dropDownList.val());
      ...
      if(dropDownList.val()!="")
      {
       ...
       {
         adultText.text('Adult standard bike $29');
         ebikeText.text('E-bike $69 (minimum age 12) Electric assisted pedalling');
         childText.text('Child (5-16 years old) standard bike $29');
         familyText.text('Family ticket. (4 persons with 2-3 children. Each person gets a bike.) $149');
                   ...
                   adultText.text('Adult standard bike $19');
                   ebikeText.text('E-bike $49 (minimum age 12) Electric assisted pedalling');
                   childText.text('Child (5-16 years old) standard bike $19');
